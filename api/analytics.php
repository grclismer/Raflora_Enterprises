...
class PerformanceAnalytics {
    ...
    public function getQuickStats() {
        $sql = "SELECT 
                    ...
                    (SELECT SUM(total_price) FROM booking_tbl WHERE booking_status IN ('APPROVED', 'COMPLETED')) as total_revenue,
                    (SELECT AVG(rating) FROM client_ratings_tbl WHERE is_approved = TRUE) as avg_rating,
